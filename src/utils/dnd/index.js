...
var increase = function increase(target, axis, withPlaceholder) {
	if (withPlaceholder && withPlaceholder.increasedBy) {
		...
		return _extends(
			{},
			target,
			((_extends2 = {}), (_extends2[axis.end] = target[axis.end] + withPlaceholder.increasedBy[axis.line]), _extends2),
		);
	}
...
var reducer = function (state, action) {
	...
	if (action.type === 'UPDATE_DROPPABLE_IS_ENABLED') {
		...
		!_target
			? process.env.NODE_ENV !== 'production'
				? invariant(false, 'Cannot find Droppable[id: ' + _id + '] to toggle its enabled state')
				: invariant(false)
			: void 0;
	...
	if (action.type === 'UPDATE_DROPPABLE_IS_COMBINE_ENABLED') {
		...
		!_target2
			? process.env.NODE_ENV !== 'production'
				? invariant(false, 'Cannot find Droppable[id: ' + _id2 + '] to toggle its isCombineEnabled state')
				: invariant(false)
			: void 0;
...
var getViewport = function () {
	...
	var frame = getRect({
		// top: top,
		// left: left ,
		// right: right / zoom + window.screenX,
		// bottom: bottom / zoom + window.scrollY,
	});
	var viewport = {
		frame: frame,
		scroll: {
...
var shared = [
	function required(_ref) {
		...
		!(typeof props.droppableId === 'string')
			? process.env.NODE_ENV !== 'production'
				? invariant(false, 'A Droppable requires a [string] droppableId. Provided: [' + typeof props.droppableId + ']')
				: invariant(false)
			: void 0;
	},
...
function getDraggingStyle(dragging) {
	...
	var transform = isDropAnimating ? transforms.drop(offset, isCombining) : transforms.moveTo({ x: offset.x / zoom, y: offset.y / zoom });
...
function useValidation$1(props, contextId, getRef) {
	useDevSetupWarning(function () {
		...
		!(typeof id === 'string')
			? process.env.NODE_ENV !== 'production'
				? invariant(false, 'Draggable requires a [string] draggableId.\n      Provided: [type: ' + typeof id + '] (value: ' + id + ')')
				: invariant(false)
			: void 0;
